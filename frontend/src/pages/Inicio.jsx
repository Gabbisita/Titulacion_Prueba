...
const Inicio = () => {
  const recientes = [
    ...
    { id: 3, n: 'Osciloscopio', i: '📡', d: 0, e: 'AGOTADO' },
      ...
      <section className="py-20 px-20 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {recientes.map((m) => (
            ...
            >
              <div className="bg-slate-50 w-full aspect-square rounded-[2rem] flex items-center justify-center text-5xl mb-6 shadow-inner italic">
                {m.i}
              </div>
